...
_microsoft = dict(
    [(key, value) for key, value in _corporate.items() if key.startswith("microsoft")]
)
_google = dict(
    [(key, value) for key, value in _corporate.items() if key.startswith("google")]
)
_airbnb = dict(
    [(key, value) for key, value in _corporate.items() if key.startswith("airbnb")]
)
_bcg = dict(
    [(key, value) for key, value in _corporate.items() if key.startswith("bcg")]
)
